                  ...
                  <form method="post">
                    <div class="form-group row mb-3">
                      <div class="col-xl-6">
                        ...
                        <input type="text" class="form-control" name="courseName" id="exampleInputFirstName" placeholder="BBA,BCA..">
                      </div>
                      <div class="col-xl-6">
                        <label class="form-control-label">Total Years<span class="text-danger ml-2">*</span></label>
                        <input type="text" class="form-control" name="year" id="exampleInputFirstName" placeholder="3,4..">
                      </div>
                    </div>
                          ...
                          if ($num > 0) {
                            while ($rows = $rs->fetch_assoc()) {
                              ...
                              <tr>
                                ...
                                <td><a href='?Id=" . $rows['CourseID'] . "'><i class='fas fa-fw fa-trash'></i>Delete</a></td>
                              </tr>";
                            }
                          } else {
                            echo
