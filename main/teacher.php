      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <!-- Form Basic -->
              <a href="register.php?type=2"><input type="button" class="btn btn-primary" value = "Add Teacher"></a>
                    ...
                    <div class="table-responsive p-3">
                      <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        ...
                        <tbody>
                          ...
                          <?php
                          $query = "SELECT * FROM users WHERE users.Type = '2'";
                          $rs = $conn->query($query);
                          $num = $rs->num_rows;
                          $sn = 0;
                          $status = "";
                          if ($num > 0) {
                            while ($rows = $rs->fetch_assoc()) {
                              ...
                              <td><a href='edit.php?action=edit&Id=".$rows['ID']."&type=2'><i class='fas fa-fw fa-edit'></i></a></td>
